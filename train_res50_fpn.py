...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    backbone = resnet50_fpn_backbone(pretrain_path="F:/fasterrcnn_voc2012.pth",
    ...
    if load_pretrain_weights:
        ...
        weights_dict = torch.load("F:/fasterrcnn_voc2012.pth", map_location='cpu')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--wd', '--weight-decay', default=1e-4, type=float,
                        ...
                        dest='weight_decay')
    # 训练的batch size                  default=8, type=int, metavar='N',
